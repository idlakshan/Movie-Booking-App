    ...
    return (
        <View>
            <ImageBackground style={{ aspectRatio: 5 / 2, height: 170 }}
                source={{
                    uri: "https://images.indianexpress.com/2024/01/fighter-06012024.jpg",
                }}>
                ...
                <Pressable style={{
                    ...
                    <Text style={{ fontSize: 14, fontWeight: "500", color: "gray" }}>Releaseing in 1 days</Text>
                    ...
                    <View style={{
                        ...
                        <View>
                            <Text style={{ fontSize: 16, fontWeight: "bold" }}>FIGHTER</Text>
                            <Text style={{ fontSize: 16, fontWeight: "400", color: "gray", marginTop: 4, }}>U/A • HINDI</Text>
                        </View>
